...
def onnx2trt(onnxFile, plan_name):
    ...
    token_type_ids = network.get_input(2)
...
def trt_infer(plan_name):
    ...
    print(encoded_input['input_ids'].detach().numpy())
    print(encoded_input['attention_mask'].detach().numpy())
    print(encoded_input['token_type_ids'].detach().numpy())
